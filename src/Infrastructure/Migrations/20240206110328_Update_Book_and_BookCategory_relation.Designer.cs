...
namespace clean_arc_api.Infrastructure.Migrations
{
    ...
    [Migration("20240206110328_Update_Book_and_BookCategory_relation")]
    partial class Update_Book_and_BookCategory_relation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("clean_arc_api.Infrastructure.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("clean_arc_api.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("clean_arc_api.Domain.Entities.TodoItem", b =>
                {
                    b.HasOne("clean_arc_api.Domain.Entities.TodoList", "List")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("clean_arc_api.Domain.Entities.TodoList", b =>
                {
                    b.OwnsOne("clean_arc_api.Domain.ValueObjects.Colour", "Colour", b1 =>
                        {
